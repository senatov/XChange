...
public class BitbayAdapterTest {
	...
	public void testOpenOrdersAdapter() throws IOException {
		...
		assertThat(openOrders.getOpenOrders().get(0).getInstrument()).isEqualTo(CurrencyPair.BTC_EUR);
		...
		assertThat(openOrders.getOpenOrders().get(1).getInstrument()).isEqualTo(CurrencyPair.BTC_EUR);
