...
public class TradingPairsJSONTest {
	...
	public void testUnmarshal() throws IOException {
		...
		InputStream is = TradingPairsJSONTest.class.getResourceAsStream("/org/knowm/xchange/coinmate/dto/metadata/example-tradingpairs.json");
		...
		assertThat(coinmateTradingPairs.getData().get(0).getOrderBookWebSocketChannelId()).isEqualTo("order_book-BTC_EUR");
		assertThat(coinmateTradingPairs.getData().get(0).getTradeStatisticsWebSocketChannelId()).isEqualTo("statistics-BTC_EUR");
		assertThat(coinmateTradingPairs.getData().get(0).getTradesWebSocketChannelId()).isEqualTo("trades-BTC_EUR");
	}
}