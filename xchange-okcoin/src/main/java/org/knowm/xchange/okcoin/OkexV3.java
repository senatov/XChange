...
public interface OkexV3 {
	...
	String OK_ACCESS_PASSPHRASE = "OK-ACCESS-PASSPHRASE";
	String OK_ACCESS_KEY = "OK-ACCESS-KEY";
	String OK_ACCESS_SIGN = "OK-ACCESS-SIGN";
	String OK_ACCESS_TIMESTAMP = "OK-ACCESS-TIMESTAMP";
