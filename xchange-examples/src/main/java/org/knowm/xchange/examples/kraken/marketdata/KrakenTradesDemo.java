...
public class KrakenTradesDemo {
	...
	private static void raw(Exchange krakenExchange) throws IOException {
		...
		long last = krakenPublicTrades.last();
		System.out.println(krakenPublicTrades.trades());
		System.out.println("Trades size: " + krakenPublicTrades.trades().size());
		System.out.println("Trades(0): " + krakenPublicTrades.trades().get(0).toString());
