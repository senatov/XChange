...
public class CoingiOrderBook {
	private final Collection<CoingiOrderGroup> asks;

	private final Collection<CoingiOrderGroup> bids;

	private final List<CoingiDepthRange> askDepthRange;

	private final List<CoingiDepthRange> bidDepthRange;
