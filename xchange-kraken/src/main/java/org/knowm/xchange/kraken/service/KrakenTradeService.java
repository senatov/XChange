...
public class KrakenTradeService extends KrakenTradeServiceRaw implements TradeService {
	...
	public OpenOrders getOpenOrders(OpenOrdersParams params) throws IOException {
		...
		if (params instanceof OpenOrdersParamCurrencyPair openOrdersParamCurrencyPair) {
	...
	public boolean cancelOrder(String orderId) throws IOException {
		return super.cancelKrakenOrder(orderId).count() > 0;
	}
	...
	public UserTrades getTradeHistory(TradeHistoryParams params)
		...
		if (params instanceof TradeHistoryParamsIdSpan idSpan) {
