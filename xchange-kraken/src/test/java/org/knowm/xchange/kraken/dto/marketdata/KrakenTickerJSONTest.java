...
public class KrakenTickerJSONTest {
	...
	public void testUnmarshal() throws IOException {
		...
		assertThat(krakenTicker.getAsk().price()).isEqualTo(new BigDecimal("562.26651"));
		assertThat(krakenTicker.getAsk().volume()).isEqualTo(new BigDecimal("1"));
		assertThat(krakenTicker.getBid().price()).isEqualTo(new BigDecimal("560.46600"));
		assertThat(krakenTicker.getBid().volume()).isEqualTo(new BigDecimal("1"));
		assertThat(krakenTicker.getClose().price()).isEqualTo(new BigDecimal("560.87711"));
		assertThat(krakenTicker.getClose().volume()).isEqualTo(new BigDecimal("0.01447739"));
