...
public class KrakenDepthJSONTest {
	...
	public void testUnmarshal() throws IOException {
		...
		List<KrakenPublicOrder> krakenAsks = krakenDepths.get("XXBTZEUR").asks();
		KrakenPublicOrder krakenPublicOrder = krakenAsks.get(0);
		assertThat(krakenPublicOrder.price()).isEqualTo(new BigDecimal("530.75513"));
		assertThat(krakenPublicOrder.volume()).isEqualTo(new BigDecimal("0.248"));
		assertThat(krakenPublicOrder.timestamp()).isEqualTo(1391825343L);
	}
}