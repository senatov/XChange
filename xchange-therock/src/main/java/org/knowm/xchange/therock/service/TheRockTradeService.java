...
public class TheRockTradeService extends TheRockTradeServiceRaw implements TradeService {
	...
	public boolean cancelOrder(CancelOrderParams params) throws IOException {
		if (!(params instanceof CancelOrderByIdParams paramId)) {
			return false;
		}
		CurrencyPair currencyPair;
		if (params instanceof CancelOrderByCurrencyPair paramCurrencyPair) {
	...
	public UserTrades getTradeHistory(TradeHistoryParams params) throws IOException {
		if (!(params instanceof TradeHistoryParamCurrencyPair pairParams)) {
		...
		if (params instanceof TradeHistoryParamsIdSpan trId) {
			try {
		...
		Date after = null;
		Date before = null;
		if (params instanceof TradeHistoryParamsTimeSpan time) {
