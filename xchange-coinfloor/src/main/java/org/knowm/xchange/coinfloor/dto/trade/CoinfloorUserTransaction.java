...
public class CoinfloorUserTransaction {
	...
	public BigDecimal getAmount() {
		if (isTrade()) {
			if (getCurrencyPair().base == BTC) {
				return btc;
			} else if (getCurrencyPair().base == XRP) {
				return xrp;
			} else if (getCurrencyPair().base == LTC) {
				return ltc;
			} else if (getCurrencyPair().base == ETH) {
				return eth;
			} else if (getCurrencyPair().base == BCH) {
				return bch;
			} else {
