...
import static org.knowm.xchange.coinfloor.dto.trade.CoinfloorUserTransaction.TransactionType.DEPOSIT;
import static org.knowm.xchange.coinfloor.dto.trade.CoinfloorUserTransaction.TransactionType.TRADE;
import static org.knowm.xchange.coinfloor.dto.trade.CoinfloorUserTransaction.TransactionType.WITHDRAWAL;
...
public class CoinfloorUserTransactionTest {
	...
	public void unmarshalTest() throws IOException {
		...
		assertThat(btcDeposit.getType()).isEqualTo(DEPOSIT);
		...
		assertThat(btcDeposit.getCurrency()).isEqualTo(BTC);
		...
		assertThat(gbpWithdrawal.getCurrency()).isEqualTo(GBP);
		...
		assertThat(tradeSell.getType()).isEqualTo(TRADE);
		...
		assertThat(tradeBuy.getType()).isEqualTo(TRADE);
