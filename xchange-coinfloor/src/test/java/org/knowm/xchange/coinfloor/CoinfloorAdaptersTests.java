...
public class CoinfloorAdaptersTests {
	...
	@Test
	public void adaptTransactionTest() throws IOException {
		InputStream is =
				getClass()
						.getResourceAsStream(
	...
	@Test
	public void adaptTradeHistoryTest() throws IOException {
		InputStream is =
				getClass()
						.getResourceAsStream(
	...
	@Test
	public void adaptOpenOrderTest() throws IOException {
		InputStream is =
				getClass()
