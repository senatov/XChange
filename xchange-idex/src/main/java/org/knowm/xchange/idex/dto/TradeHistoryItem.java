...
public class TradeHistoryItem {
	...
	public String toString() {
		String sb = "class TradeHistoryItem {\n" +
				...
				"    buyerFee: " + toIndentedString(buyerFee) + "\n" +
				"    sellerFee: " + toIndentedString(sellerFee) + "\n" +
				"    gasFee: " + toIndentedString(gasFee) + "\n" +
				"    timestamp: " + toIndentedString(timestamp) + "\n" +
				"    maker: " + toIndentedString(maker) + "\n" +
				"    taker: " + toIndentedString(taker) + "\n" +
