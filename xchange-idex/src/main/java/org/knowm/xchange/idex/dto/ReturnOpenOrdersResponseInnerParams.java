...
public class ReturnOpenOrdersResponseInnerParams {
	...
	public String toString() {
		String sb = "class ReturnOpenOrdersResponseInnerParams {\n" +
				"    tokenBuy: " + toIndentedString(tokenBuy) + "\n" +
				"    buySymbol: " + toIndentedString(buySymbol) + "\n" +
				"    buyPrecision: " + toIndentedString(buyPrecision) + "\n" +
				"    amountBuy: " + toIndentedString(amountBuy) + "\n" +
				"    tokenSell: " + toIndentedString(tokenSell) + "\n" +
				"    sellSymbol: " + toIndentedString(sellSymbol) + "\n" +
				"    sellPrecision: " + toIndentedString(sellPrecision) + "\n" +
