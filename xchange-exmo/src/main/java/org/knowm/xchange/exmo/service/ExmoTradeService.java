...
public class ExmoTradeService extends ExmoTradeServiceRaw implements TradeService {
	...
	public boolean cancelOrder(CancelOrderParams orderParams) throws IOException {
		if (orderParams instanceof CancelOrderByIdParams params) {
	...
	public UserTrades getTradeHistory(TradeHistoryParams params) throws IOException {
		...
		if (params instanceof ExmoTradeHistoryParams exmoTradeHistoryParams) {
			currencyPairs.addAll(exmoTradeHistoryParams.getCurrencyPairs());
		} else if (params instanceof TradeHistoryParamCurrencyPair tradeHistoryParamCurrencyPair) {
