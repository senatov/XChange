...
public class ExmoAccountService extends ExmoAccountServiceRaw implements AccountService {
	...
	public String withdrawFunds(WithdrawFundsParams params) throws IOException {
		...
		if (params instanceof RippleWithdrawFundsParams rippleWithdrawFundsParams) {
			result =
					exmo.withdrawCrypt(
							signatureCreator,
							apiKey,
		...
		} else if (params instanceof DefaultWithdrawFundsParams defaultWithdrawFundsParams) {
			result =
					exmo.withdrawCrypt(
							signatureCreator,
							apiKey,
	...
	public List<FundingRecord> getFundingHistory(TradeHistoryParams params) throws IOException {
		Date since = null;
		if (params instanceof ExmoFundingHistoryParams thp) {
			since = thp.getDay();
		}
