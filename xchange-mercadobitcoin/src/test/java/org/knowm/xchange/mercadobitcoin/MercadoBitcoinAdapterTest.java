...
import static org.knowm.xchange.currency.CurrencyPair.BTC_BRL;
...
public class MercadoBitcoinAdapterTest {
	...
	public void testOrderBookAdapter() throws IOException {
		...
		OrderBook orderBook =
				MercadoBitcoinAdapters.adaptOrderBook(mercadoBitcoinOrderBook, BTC_BRL);
		...
		assertThat(orderBook.getBids().get(0).getInstrument()).isEqualTo(BTC_BRL);
	}
	...
	public void testTradesAdapter() throws IOException {
		...
		Trades trades = MercadoBitcoinAdapters.adaptTrades(transactions, BTC_BRL);
		...
		assertThat(trades.getTrades().get(0).getInstrument()).isEqualTo(BTC_BRL);
	}
	...
	public void testTickerAdapter() throws IOException {
		...
		Ticker ticker = MercadoBitcoinAdapters.adaptTicker(mercadoBitcoinTicker, BTC_BRL);
