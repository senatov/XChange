...
public class CexioWebSocketTransaction {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof CexioWebSocketTransaction that))
			return false;
		if (!Objects.equals(id, that.id))
			return false;
		if (!Objects.equals(d, that.d))
			return false;
		if (!Objects.equals(c, that.c))
			return false;
		if (!Objects.equals(user, that.user))
			return false;
		if (!Objects.equals(symbol, that.symbol))
			return false;
		if (!Objects.equals(symbol2, that.symbol2))
			return false;
		if (!Objects.equals(buy, that.buy))
			return false;
		if (!Objects.equals(order, that.order))
			return false;
		if (!Objects.equals(sell, that.sell))
			return false;
		if (!Objects.equals(type, that.type))
			return false;
		if (!Objects.equals(time, that.time))
			return false;
		if (a != null ? a.compareTo(that.a) != 0 : that.a != null)
			return false;
		if (ds != null ? ds.compareTo(that.ds) != 0 : that.ds != null)
			return false;
		if (cs != null ? cs.compareTo(that.cs) != 0 : that.cs != null)
			return false;
