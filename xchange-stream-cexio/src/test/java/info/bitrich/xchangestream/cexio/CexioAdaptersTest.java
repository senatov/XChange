	...
	public void testAdaptOrderBookIncremental() {
		...
		askOrders.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(10), new BigDecimal(500))));
		askOrders.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(11), new BigDecimal(400))));
		askOrders.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(13), new BigDecimal(200))));
		List<List<BigDecimal>> bidOrders = new ArrayList<List<BigDecimal>>();
		bidOrders.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(10), new BigDecimal(200))));
		bidOrders.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(9), new BigDecimal(100))));
		bidOrders.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(7), new BigDecimal(50))));
		...
		askOrders2.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(10), new BigDecimal(400))));
		askOrders2.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(11), new BigDecimal(600))));
		askOrders2.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(12), new BigDecimal(100))));
		askOrders2.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(15), new BigDecimal(50))));
		List<List<BigDecimal>> bidOrders2 = new ArrayList<List<BigDecimal>>();
		bidOrders2.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(9), new BigDecimal(150))));
		bidOrders2.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(8), new BigDecimal(70))));
		bidOrders2.add(
				new ArrayList<BigDecimal>(
						Arrays.asList(new BigDecimal(6), new BigDecimal(30))));
