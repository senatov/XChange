	...
	public CexIOOrder placeCexIOLimitOrder(LimitOrder limitOrder) throws IOException {
		CexIOOrder order =
				cexIOAuthenticated.placeOrder(
						signatureCreator,
						limitOrder.getInstrument().getBase().getCurrencyCode(),
						limitOrder.getInstrument().getCounter().getCurrencyCode(),
	...
	*/
	public CexIOOrder placeCexIOMarketOrder(MarketOrder marketOrder) throws IOException {
		CexIOOrder order =
				cexIOAuthenticated.placeOrder(
						signatureCreator,
						marketOrder.getInstrument().getBase().getCurrencyCode(),
						marketOrder.getInstrument().getCounter().getCurrencyCode(),
						new CexioPlaceOrderRequest(
