...
public class HuobiUtils {
	private static final Logger logger = LoggerFactory.getLogger(HuobiUtils.class);

	private static final Map<String, CurrencyPair> assetPairMap = new HashMap<String, CurrencyPair>();
	private static final Map<CurrencyPair, String> assetPairMapReverse =
			new HashMap<CurrencyPair, String>();
	private static final Map<String, Currency> assetMap = new HashMap<String, Currency>();
	private static final Map<Currency, String> assetMapReverse = new HashMap<Currency, String>();
