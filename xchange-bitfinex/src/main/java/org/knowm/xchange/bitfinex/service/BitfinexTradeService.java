...
public class BitfinexTradeService extends BitfinexTradeServiceRaw implements TradeService {
	...
	public UserTrades getTradeHistory(TradeHistoryParams params) throws IOException {
		try {
			...
			Long limit = 50L;
			Long sort = null;
			if (params instanceof TradeHistoryParamsTimeSpan paramsTimeSpan) {
			...
			if (params instanceof TradeHistoryParamLimit tradeHistoryParamLimit) {
				if (tradeHistoryParamLimit.getLimit() != null) {
					limit = Long.valueOf(tradeHistoryParamLimit.getLimit());
				}
			}
			if (params instanceof TradeHistoryParamsSorted tradeHistoryParamsSorted) {
