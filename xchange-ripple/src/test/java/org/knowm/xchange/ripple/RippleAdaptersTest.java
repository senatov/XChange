...
public class RippleAdaptersTest implements ITransferFeeSource {
	...
	public void adaptOrderBookTest() throws IOException {
		...
		assertThat(lastBid.getInstrument()).isEqualTo(currencyPair);
		...
		assertThat(firstAsk.getInstrument()).isEqualTo(currencyPair);
	...
	public void adaptOpenOrdersTest() throws JsonParseException, JsonMappingException, IOException {
		...
		assertThat(firstOrder.getInstrument()).isEqualTo(CurrencyPair.XRP_BTC);
		...
		assertThat(secondOrder.getInstrument()).isEqualTo(CurrencyPair.XRP_BTC);
	...
	public void adaptTrade_BuyXRP_SellBTC()
		...
		assertThat(ripple.getCounterTransferFeeCurrency()).isEqualTo(trade.getInstrument().getCounter());
	}
	...
	public void adaptTrade_SellXRP_BuyBTC()
		...
		assertThat(trade2.getInstrument()).isEqualTo(trade.getCurrencyPair());
