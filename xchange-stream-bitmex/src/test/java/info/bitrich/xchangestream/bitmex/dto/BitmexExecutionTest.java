...
public class BitmexExecutionTest {
	...
	public void testDesialization() throws IOException {
		...
		assertEquals(Long.valueOf(30), bitmexExecution.lastQty);
		...
		assertEquals(Long.valueOf(30), bitmexExecution.orderQty);
		assertEquals(BigDecimal.valueOf(7622.5), bitmexExecution.price);
		assertEquals(Long.valueOf(2), bitmexExecution.displayQty);
		...
		assertEquals(Long.valueOf(11), bitmexExecution.leavesQty);
		...
		assertEquals(Long.valueOf(393570), bitmexExecution.execCost);
		assertEquals(Long.valueOf(-98), bitmexExecution.execComm);
