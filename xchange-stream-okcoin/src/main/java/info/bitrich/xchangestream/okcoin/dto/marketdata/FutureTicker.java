...
public class FutureTicker {
	private final Long contractId; // 合约ID
	private final Integer unitAmount; // 合约价值
	private final BigDecimal holdAmount; // 当前持仓量

	private final BigDecimal limitHigh; // 最高买入限制价格
	private final BigDecimal limitLow; // 最低卖出限制价格

	private final BigDecimal buy; // 买一价格
	private final BigDecimal sell; // 卖一价格
	private final BigDecimal last; // 最新成交价

	private final BigDecimal high; // 24小时最高价格
	private final BigDecimal low; // 24小时最低价格
	private final BigDecimal vol; // 24小时成交量
